...
| 阶段 | 内容 | 状态 |
|------|------|------|
| M1 基础浏览 | TabManager / NavigationManager / SessionManager / ChromeUI | ✅ |
| M2 浏览增强 | 下载 / 历史 / 书签 / 设置 / 侧边栏 / DevTools / 打印 / 缩放 / 主题 | ✅ |
| M3 体验增强 | 新标签页 / 页内查找 / 自动补全 / 星标 / 拖拽排序 | ✅ |
| M3 代理 | Mihomo 代理模块 + 订阅 + 面板 UI | ✅ |
| M4 打磨打包 | 三平台打包 / 会话恢复 / 窗口持久化 / 崩溃恢复 / 标签挂起 | ✅ |
| M5 CI/CD | GitHub Actions 三平台构建矩阵 / 代码签名 / 自动更新 / 测试覆盖扩展 | ⏳ 下一步 |

长期愿景：对标 Arc/Zen 的架构体验，将代理、AI、下载、历史、会话、浏览核心作为独立模块，最大化可维护性。

## License

本软件以 [The Unlicense](./LICENSE) 释出至公有领域（最宽松授权，可用于任何用途，无需署名）。
